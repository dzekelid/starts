...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-step-functions/apis.md
...
- name: AWS Step Functions API - Start Execution
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-step-functions/actionstartexecution-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-step-functions/actionstartexecution-get-openapi.md
- name: AWS Step Functions API - Start Execution
  x-api-slug: actionstartexecution-get
  description: Starts a state machine execution.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-step-functions.png
