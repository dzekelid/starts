...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-config/apis.md
...
- name: AWS Config API - Start Configuration Recorder
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-config/actionstartconfigurationrecorder-get-openapi.md
- name: AWS Config API - Start Config Rules Evaluation
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-config/actionstartconfigrulesevaluation-get-openapi.md
- name: AWS Config API - Start Configuration Recorder
  x-api-slug: actionstartconfigurationrecorder-get
  description: Starts recording configurations of the AWS resources you have selected
    to record in your AWS account.
