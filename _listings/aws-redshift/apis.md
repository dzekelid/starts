...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-redshift/apis.md
...
- name: AWS Redshift API - Enable Logging
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-redshift/actionenablelogging-get-openapi.md
- name: AWS Redshift API - Enable Logging
  x-api-slug: actionenablelogging-get
  description: |-
    Starts logging information, such as queries and connection attempts, for the
