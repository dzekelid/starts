...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-cognito/apis.md
...
- name: AWS Cognito Merged API - Start User Import Job
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-cognito/actionstartuserimportjob-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-cognito/actionstartuserimportjob-get-openapi.md
- name: AWS Cognito Merged API - Start User Import Job
  x-api-slug: actionstartuserimportjob-get
  description: Starts the user import.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-cognito.png
