...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-lightsale/apis.md
...
- name: AWS Lightsale API - Start Instance
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/starts/master/_listings/aws-lightsale/actionstartinstance-get-openapi.md
- name: AWS Lightsale API - Start Instance
  x-api-slug: actionstartinstance-get
  description: Starts a specific Amazon Lightsail instance from a stopped state.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/aws-lightsail.png
